...
const CurriculumPageToPrint = () => {
  const generatePDF = () => {
    let element = document.querySelector(".curriculum-page-container");
    let options = {
      filename: "test.pdf",
      excludeClassNames: ['download-button']
    };
      ...
      <div className="curriculum-page-container">
        <div className="personal-information">
          <div className="main-profile">
            <div className="download-button" onClick={generatePDF}>
              <img src={DownloadIcon} alt="" />
            </div>
            <div className="profile-image">
              {/* <img
                src="https://putsch.media/wp-content/uploads/2019/04/pierre-person-putsch-800x1000.jpg"
                alt=""
              /> */}
            </div>
...
export default CurriculumPageToPrint;
